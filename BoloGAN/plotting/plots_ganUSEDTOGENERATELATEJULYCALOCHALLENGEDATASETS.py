...
if __name__ == "__main__":
  ...
  h5outputFile = h5py.File("{}/caloChallengeDataset_Dataset1HighStatsPhotons.h5".format(output_dir_gan), "w")
  ...
  for index, energy in enumerate(dataParameters.momentums):    
    ...
    h5outputFile.create_dataset("dataset_pid{}_E{}_eta_{}_{}_index_{}_GAN".format(pid, energy, eta_min, eta_max, index), data=data)
