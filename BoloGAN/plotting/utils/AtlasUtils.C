...
void ATLAS_LABEL(Double_t x,Double_t y, Color_t color, const char * legend) 
{
  ...
  l.SetTextFont(42);
  l.DrawLatex(x+0.145,y,"Simulation internal");
  l.DrawLatex(x,y-0.05, legend); //E=1.048 TeV");
//l.DrawLatex(x+0.02,y-0.05,"E=1.048 TeV");

}

void ATLAS_LABEL_LONG(Double_t x,Double_t y, Color_t color, const char * legend) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
  ...
  l.SetTextFont(42);
  l.DrawLatex(x+0.145,y,"Simulation internal");
  l.DrawLatex(x,y-0.07, legend); //E=1.048 TeV");
//l.DrawLatex(x+0.02,y-0.05,"E=1.048 TeV");

}

void ATLAS_LABEL_BIG(Double_t x,Double_t y, Color_t color, const char * legend) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
  ...
  l.SetTextFont(42);
  l.SetTextSize(0.11);
  l.DrawLatex(x,y-0.13,"Simulation Internal");
  l.DrawLatex(x,y-0.26, legend); //E=1.048 TeV");
//l.DrawLatex(x+0.02,y-0.05,"E=1.048 TeV");

}

void ATLAS_PREL_LABEL_BIG(Double_t x,Double_t y, Color_t color, const char * legend) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
  ...
  l.SetTextFont(42);
  l.SetTextSize(0.09);
  l.DrawLatex(x,y-0.13,"Simulation Preliminary");
  l.DrawLatex(x,y-0.26, legend); //E=1.048 TeV");
//l.DrawLatex(x+0.02,y-0.05,"E=1.048 TeV");
