...
function SetVoxelisationDir(){
  vox_dir="/eos/atlas/atlascerngroupdisk/proj-simul/AF3_Run3/VoxalisationOutputs/corchia/caloChallengeHighStatsEXNOVO/" #${binningName}/" #"/eos/atlas/atlascerngroupdisk/proj-simul/AF3_Run3/VoxalisationOutputs/corchia/${binningName}/truePions/${binningName}/"
